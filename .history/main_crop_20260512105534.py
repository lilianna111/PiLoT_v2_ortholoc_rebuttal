...
def load_poses(pose_file, origin = None):
    ...
    return pose_dict
def load_k_and_size(k_json_path = "/home/amax/Documents/code/lxy/PiLoT_v55/crop/K_google.json"):
    import json
...
class DualProcessTask:        
    def __init__(self, config, init_euler = None, init_trans = None, name = None):
        ...
        output_folder = "/media/amax/AE0E2AFD0E2ABE69/outputs"
        ...
        # output_folder = "/media/amax/AE0E2AFD0E2ABE69/datasets/mapscape/outputs_both"
        # output_folder = "/media/amax/AE0E2AFD0E2ABE69/datasets/outputs/FPVLoc_depth_weixing"
        if not os.path.exists(output_folder):
            os.makedirs(output_folder)
        pre_path = "/media/amax/AE0E2AFD0E2ABE69/datasets/test"
        depth_txt_folder = "/media/amax/PS2000/Test/depth_pose"
        angle_txt_folder = "/media/amax/PS2000/Test/angle"
        ...
        # self.depth_txt_path ="/media/amax/PS2000/USA_seq2@8@foggy@intensity3@200.txt"
        # self.angle_txt_path ="/media/amax/PS2000/USA_seq2@8@foggy@200_angle.txt"
    ...
    def rendering_worker(self):
        ...
        # ref_npy_path = "/media/amax/AE0E2AFD0E2ABE69/datasets/DSM/0.3/0.3/npy_0.3_wgs84.npy"
        ref_DSM_path = "/home/amax/Downloads/wgs84/dsm/sw4dsm.tif"
        ref_DOM_path = "/home/amax/Downloads/wgs84/dom/sw4dom.tif"
        ref_npy_path = "/home/amax/Downloads/wgs84/npy/sw4.npy"
