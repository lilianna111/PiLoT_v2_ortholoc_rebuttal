...
def load_poses(pose_file, origin = None):
    ...
    return pose_dict
def load_k_and_size(k_json_path = "/home/amax/Documents/code/lxy/PiLoT_v55/crop/K.json"):
    import json
...
class DualProcessTask:        
    ...
    def rendering_worker(self):
        ...
        ref_npy_path = "/media/amax/AE0E2AFD0E2ABE69/datasets/mapscape/model/usa_2/npy_0.3.npy"
