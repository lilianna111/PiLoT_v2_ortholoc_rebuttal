...
ORTHOLOC_CHECKPOINT_DIR="${ORTHOLOC_CHECKPOINT_DIR:-/media/amax/PS2000/checkpoint}"

DOM_PATH="${DOM_PATH:-/home/amax/Downloads/wgs84/dom/usa8dom.tif}"
DSM_PATH="${DSM_PATH:-/home/amax/Downloads/wgs84/dsm/usa8dsm.tif}"
...
export ORTHOLOC_CHECKPOINT_DIR
